-- Script untuk membuat semua tabel yang diperlukan
-- Jalankan di phpMyAdmin pada database metrochilon

-- Hapus semua tabel jika ada (untuk membersihkan tablespace)
SET FOREIGN_KEY_CHECKS = 0;

-- Hapus tablespace secara manual jika ada, kemudian drop tabel
-- Untuk setiap tabel, coba discard tablespace dulu, lalu drop
...
-- Migrations (harus dihapus terakhir)
...
-- Insert sample users (optional - untuk testing)
