...
<head>
    ...
    <style>
        ...
        *{ box-sizing:border-box; }
        ...
        .card{ background:var(--panel); border:1px solid rgba(0,102,255,.1); border-radius:20px; box-shadow:0 10px 30px rgba(0,102,255,.1); margin-bottom:24px; max-width:800px; margin:0 auto; transition: all 0.3s ease; position: relative; z-index: 1; }
            ...
            <div class="card pad">
                <div class="hero">
                    <div>
                        ...
                        <small>Isi data karyawan baru</small>
                    </div>
