...
<head>
    ...
    <style>
        ...
        *{ box-sizing:border-box; }
        ...
        @media (max-width: 980px){ .sidebar{ position:fixed; left:-280px; top:80px; z-index:999; height:calc(100vh - 80px); transition: left .3s ease; } .sidebar.active{ left:0; } .content-wrapper{ padding: 20px; } }
    </style>
</head>
<body>
<div class="shell">
                        ...
                        <tbody>
                            @forelse($employees as $employee)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.employees.show', $employee->id) }}" class="btn btn-success" style="padding:6px 12px; font-size:12px;">Detail</a>
                                        <a href="{{ route('admin.employees.edit', $employee->id) }}" class="btn btn-primary" style="padding:6px 12px; font-size:12px;">Edit</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" style="text-align:center; padding:24px; color:#9ca3af;">Belum ada karyawan</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
