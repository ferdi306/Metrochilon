...
<head>
    ...
    <title>Ubah Password - Metrochilon</title>
...
<body>
    <div class="container">
        <div class="card">
            <h2>Ubah Password</h2>
            <p class="hint">Anda diminta untuk mengubah password sebelum melanjutkan.</p>
            ...
            <div class="hint" style="margin-top:14px">Jika ada masalah, hubungi admin.</div>
        </div>
    </div>
</body>
</html>